	  ...
	  echo "<div class='col-md-6'>
			   ...
			   <label>".str_replace('_', ' ', $name)."</label>";
				...
				while($row2 =mysqli_fetch_array($result2))
				{
					...
					echo "<option value='$row2[id]'>$row2[skill_name]</option>";
				}
	  echo "</select>";
	  echo "</div>
            </div>";
	  ...
	  echo "<div class='col-md-6'>
			   ...
			   <label>".str_replace('_', ' ', $name)."</label>";
				...
				while($row2 =mysqli_fetch_array($result2))
				{
					...
					echo "<option value='$row2[id]'>$row2[set_name]</option>";
				}
	  echo "</select>";
	  echo "</div>
            </div>";
	  ...
	  echo "<div class='col-md-6'>
			   ...
			   <label>".str_replace('_', ' ', $name)."</label>";
				...
				echo "<select name='$name' class='form-control'>";
					...
					echo "<option value='basic'>Basic (0 - 2 years)</option>";
					echo "<option value='intermediate'>Intermediate (3 - 5 years)</option>";
					echo "<option value='advanced'>Advanced (6+ years)</option>";
	  echo "</select>";
	  echo "</div>
            </div>";
  }
